          ...
          {Object.entries(groupedShowtimes).map(([date, showtimes]) => (
            <div key={date} className="mb-6">
              ...
              {showtimes.map((showtime) => (
                <div key={showtime.id} className="flex items-center justify-between bg-secondary p-3 rounded-md mb-2">
                  <div>
                  ...
                  <Button variant="ghost" size="icon" onClick={() => onDelete(showtime.id)}>
